...
│                     CORE MODULES LAYER                          │
│  ┌───────────────┬───────────────┬──────────────────────────┐  │
│  │ src/auth.py   │ src/config.py │ src/iris_selectors.py    │  │
│  │               │               │                          │  │
...
│  ┌───────────────┬───────────────┬──────────────────────────┐  │
│  │src/database.py│src/db_manager │  catalog_projects.db     │  │
│  │               │               │                          │  │
...
│                     UTILITIES LAYER                             │
│  ┌───────────────┬───────────────┬──────────────────────────┐  │
│  │ src/utils.py  │src/downloader │  OUTPUT ARTIFACTS        │  │
│  │               │               │                          │  │
...
### **1. src/scrape_catalog_phase1.py** (Entry Point)
