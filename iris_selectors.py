...
CATALOG_CONTAINER: Final[str] = (
    "[class*='catalog'], [class*='listing'], [class*='grid'], main, article"
)
...
APARTMENT_LOCATION: Final[str] = (
    "[class*='location'], [class*='address'], [class*='ubicacion'], [class*='barrio']"
)
...
PROJECT_DETAIL_LINK: Final[str] = (
    "a[href*='/proyecto/'], a[href*='/proyectos/'], .project-link, [data-project-link]"
)
