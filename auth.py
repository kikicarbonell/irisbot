...
from config import PLAYWRIGHT_TIMEOUT_MS, IRIS_EMAIL, IRIS_PASSWORD
...
async def authenticate(page: Page, email: str | None = None, password: str | None = None) -> bool:
    ...
    try:
        ...
        if "/proyectos" not in current_url:
            ...
            try:
                await page.goto("https://iris.infocasas.com.uy/proyectos?country=1&order=promos%2Cpopularity", wait_until="domcontentloaded")
